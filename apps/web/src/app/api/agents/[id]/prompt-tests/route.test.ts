...
test('default prompt test inputs are generated by the backend and accepted by every registered test', async () => {
  ...
  const llmOutputs: Record<string, string> = {
    ...
    'memory.contextToShortTerm': '{"memories":[{"detail":"原文说明用户喜欢星际2，Stage A 应保留 surface“星际2”。","retrieval_text":"用户说星际2是自己喜欢的游戏。","importance":0.7}]}',
    'memory.entityMention': '{"mentions":[{"surface":"星际2","type":"object","context_hint":"用户提到的游戏简称","confidence":0.91}]}',
    'memory.episodicExtraction': '{"entities":[{"local_entity_id":"local-game-1","surface":"星际2","type":"object","context_hint":"用户提到的游戏简称"}],"episodic_memories":[{"summary":"用户最喜欢的游戏是星际2。","detail":"我最喜欢的游戏是星际2。","importance":0.82,"entity_links":[{"local_entity_id":"local-game-1","weight":0.9}]}]}',
